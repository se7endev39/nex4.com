  ...
  <div class="navbar-content">
    <div class="nav-phone hidden-md-up">
      ...
      >
        <div class="row p-0 section1">
          <div
            class="col-3 float-left settings-sm-icon"
          ...
          <div
            ...
            :class="{ 'offset-3': !$auth.isAuthenticated() }"
          >
          ...
          <div class="col-3 float-right search" @click="SHOW_SEARCH_PAGE">
            ...
            <div class="search-icon" v-if="showSearchPageEvent">
              <svg
                ...
                style="enable-background: new 0 0 22.135 22.135"
                xml:space="preserve"
                width="100%"
                class="sm-search-svg"
              >
                <g>
                  <g>
                    <path
                      d="M0,18.723L14.879,3.089c0,0,1.949-2.114,6.341-1.597c0,0,0.753,0.599,0.915,1.755L7.179,19.24    c0,0-1.236,1.558-6.461,1.438C0.717,20.678,0.2,20.438,0,18.723z"
                      fill="#FFFFFF"
                    />
                    <path
                      d="M0,3.412l14.879,15.634c0,0,1.949,2.114,6.341,1.597c0,0,0.753-0.598,0.915-1.758L7.179,2.891    c0,0-1.236-1.556-6.461-1.436C0.717,1.456,0.2,1.696,0,3.412z"
                      fill="#FFFFFF"
                    />
                  </g>
                </g>
              ...
              <router-link :to="{ name: 'channels' }">
                <div class="icon">
                  <svg
                    ...
                    style="enable-background: new 0 0 482.781 482.781"
                    xml:space="preserve"
                  >
                    <g>
                      <g>
                        <g>
                          <path
                            d="M71.895,248.373c-18.191,0-32.934,14.763-32.934,32.953s14.742,32.948,32.934,32.948     c49.859,0,90.402,40.56,90.402,90.402c0,18.189,14.758,32.948,32.949,32.948s32.934-14.759,32.934-32.948     C228.18,318.498,158.075,248.373,71.895,248.373z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M89.832,126.759c-18.191,0-32.934,14.762-32.934,32.953s14.742,32.949,32.934,32.949     c107.012,0,194.094,87.066,194.094,194.094c0,18.189,14.742,32.934,32.935,32.934s32.948-14.742,32.948-32.934     C349.809,243.408,233.18,126.759,89.832,126.759z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M96.383,0.15c-18.191,0-32.938,14.742-32.938,32.934s14.746,32.949,32.938,32.949     c176.723,0,320.516,143.809,320.516,320.563c0,18.19,14.741,32.934,32.936,32.934c18.207,0,32.947-14.741,32.947-32.934     C482.781,173.505,309.441,0.15,96.383,0.15z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M58.211,366.205C26.051,366.205,0,392.259,0,424.419c0,32.142,26.051,58.212,58.211,58.212     c32.145,0,58.227-26.07,58.227-58.212C116.438,392.259,90.356,366.205,58.211,366.205z"
                            fill="#d9d9d9"
                          />
                        </g>
                      </g>
              ...
              <router-link :to="{ name: 'series' }">
                <div class="icon">
                  <svg
                    ...
                    style="enable-background: new 0 0 333.6 333.6"
                    xml:space="preserve"
                    width="100%"
                  >
                    <g>
                      <g>
                        <g>
                          <path
                            d="M128,58.297h29.2l-46.8-53.6c-4-4.4-10.8-5.2-15.6-1.2c-4.4,4-5.2,10.8-1.2,15.6L128,58.297z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M226.4,41.897c4.4-4.4,4.4-11.2,0-15.6c-4.4-4.4-11.2-4.4-15.6,0l-31.6,31.6H210L226.4,41.897z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M308.8,70.297h-142h-142c-13.6,0-24.8,11.2-24.8,24.8v178c0,13.6,11.2,24.8,24.8,24.8h38.4h207.2h38.4     c13.6,0,24.8-11.2,24.8-24.8v-178C333.6,81.497,322.4,70.297,308.8,70.297z M235.6,245.897c0,9.6-7.6,17.2-17.2,17.2H54     c-9.6,0-17.2-7.6-17.2-17.2v-123.2c0-9.6,7.6-17.2,17.2-17.2h164.4c9.6,0,17.2,7.6,17.2,17.2V245.897z M306.4,207.497     c0,2-1.6,3.6-3.6,3.6h-36c-2,0-3.6-1.6-3.6-3.6v-27.2c0-2,1.6-3.6,3.6-3.6h36c2,0,3.6,1.6,3.6,3.6V207.497z M306.4,149.897     c0,2-1.6,3.6-3.6,3.6h-36c-2,0-3.6-1.6-3.6-3.6v-27.2c0-2,1.6-3.6,3.6-3.6h36c2,0,3.6,1.6,3.6,3.6V149.897z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M24.8,319.897c0,7.2,5.6,12.8,12.8,12.8h12.8c7.2,0,12.8-5.6,12.8-12.8v-10H24.8V319.897z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M270.4,319.897L270.4,319.897c0,7.2,5.6,12.8,12.8,12.8H296c7.2,0,12.8-5.6,12.8-12.8v-10h-38.4V319.897z"
                            fill="#d9d9d9"
                          />
                        </g>
                      </g>
              ...
              <router-link :to="{ name: 'movies' }">
                <div class="icon">
                  <svg
                    ...
                    style="enable-background: new 0 0 360.8 360.8"
                    xml:space="preserve"
                    width="100%"
                  >
                    <g>
                      <g>
                        <g>
                          ...
                          />
                          <path
                            d="M15.6,294.47c0,18,14.8,32.8,32.8,32.8H328c18,0,32.8-14.8,32.8-32.8v-120.8H15.6V294.47z M52.4,206.869H130     c3.2,0,5.6,2.4,5.6,5.6s-2.4,5.6-5.6,5.6H52.4c-3.2,0-5.6-2.4-5.6-5.6C46.8,209.67,49.2,206.869,52.4,206.869z M52.4,245.27     c-3.2,0-5.6-2.4-5.6-5.6s2.4-5.6,5.6-5.6H136h104.8h83.6c3.2,0,5.6,2.4,5.6,5.6s-2.4,5.6-5.6,5.6H246v42.4h78.4     c3.2,0,5.6,2.4,5.6,5.6s-2.4,5.6-5.6,5.6h-83.6H136H52.4c-3.2,0-5.6-2.4-5.6-5.6s2.4-5.6,5.6-5.6h78v-42.4H52.4z"
                            fill="#d9d9d9"
                          />
                          <polygon
                            points="154,100.07 198.4,46.07 151.2,50.87 106.8,104.47    "
                            fill="#d9d9d9"
                          />
                          <polygon
                            points="234,92.07 278,38.47 231.2,42.87 186.8,96.869    "
                            fill="#d9d9d9"
                          />
                          <path
                            d="M46,96.47v14.4l28.4-2.8l44.4-54l-77.6,7.6c-10,0.8-18.4,6.8-23.2,15.2h8.8C37.2,76.47,46,85.27,46,96.47z"
                            fill="#d9d9d9"
                          />
                          <path
                            d="M359.2,80.07l-2-19.2c-1.6-16.4-16.4-28.8-32.8-27.2l-13.6,1.2l-44.4,54L359.2,80.07z"
                            fill="#d9d9d9"
                          />
                          <polygon
                            points="204,162.869 154.8,113.67 107.2,113.67 156.8,162.869    "
                            fill="#d9d9d9"
                          />
                          <path
                            d="M46,113.67v15.2c0,10.8-8.8,19.6-19.6,19.6H15.6v14.4H124l-49.6-49.2H46z"
                            fill="#d9d9d9"
                          />
                          <polygon
                            points="284,162.869 234.8,113.67 187.6,113.67 236.8,162.869    "
                            fill="#d9d9d9"
                          />
                          <polygon
                            points="267.6,113.67 317.2,162.869 360.8,162.869 360.8,113.67    "
                            fill="#d9d9d9"
                          />
                          <path
                            d="M34,128.869v-32.4c0-4.4-3.6-7.6-7.6-7.6H7.6c-4.4,0-7.6,3.6-7.6,7.6v32.4c0,4.4,3.6,7.6,7.6,7.6h18.8     C30.8,136.47,34,132.869,34,128.869z"
                            fill="#d9d9d9"
                          />
                        </g>
                      </g>
      ...
      <div
        class="col-3 sidebar-content sidebar-sm"
        v-if="show_sidebar && $auth.isAuthenticated() === 'active'"
      >
        <div class="sidebar">
    ...
    <div class="col-xl-8 offset-xl-2 nav-md m-5 hidden-sm-down">
      <div
        ...
        :class="{ 'nav-background-active': showNavBackground }"
      ></div>
      ...
      >
        ...
        <div
          class="offset-xl-1 collapse navbar-collapse"
        ...
        >
          <ul class="navbar-nav mr-auto mt-2 mt-md-0">
            ...
            <li class="nav-item">
              <router-link class="nav-link" :to="{ name: 'kids' }">{{
                $t("home.kids")
              }}</router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <router-link class="nav-link" :to="{ name: 'manga' }">
                MANGA
              </router-link>
            </li>
            <li class="nav-item" v-if="collections.length > 0">
              <div class="dropdown">
                ...
                <div
                  ...
                  aria-labelledby="dropdownCollection"
                >
                  <router-link
                    class="dropdown-item"
