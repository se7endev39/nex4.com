<template>
    <div class="navbar-content">
        ...
        <div class="col-xl-8 offset-xl-2 nav-md m-5 hidden-sm-down">
            ...
            <nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse fixed-top min-height-5">
                    ...
                    <div class="search" @click="SHOW_SEARCH_PAGE">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8 offset-md-2 search-page__nav_search">
                                ...
                                <input class="form-control mr-sm-2 max-height-2" type="text" :placeholder="$t('home.search')" v-model="search_query">
                            </div>
