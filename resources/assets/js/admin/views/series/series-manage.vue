                ...
                <td>
                  <div class="btn-group" role="group">
                    ...
                    <router-link
                      class="btn btn-sm btn-warning btn-sm mr-2"
                      role="buttton"
                      :to="{ name: 'episode-ads', params: { id: item.id } }"
                    >
                      Ads
                    </router-link>
                  </div>
          ...
          <ul class="pagination">
            <li class="page-item" id="end">
              <a
                class="page-link"
                @click="
                  PAGINATION('/api/admin/get/series/season/' + $route.params.id)
                "
                >Begin</a
              >
            </li>
            <li
              class="page-item"
              id="prev"
              :class="{ disabled: data.season.prev_page_url === null }"
            >
              <a
                class="page-link"
                @click="PAGINATION(data.season.prev_page_url)"
                >Previous</a
              >
            </li>
            <li class="page-item">
              <a class="page-link"
                >{{ data.season.current_page }}/{{ data.season.last_page }}</a
              >
            </li>
            <li
              class="page-item"
              id="next"
              :class="{ disabled: data.season.next_page_url === null }"
            >
              <a
                class="page-link"
                @click="PAGINATION(data.season.next_page_url)"
                >Next</a
              >
            </li>
            <li class="page-item" id="end">
...
export default {
  ...
  methods: {
    ...
    AVAILABLE_IT(id, index) {
      ...
      axios
        .post("/api/admin/update/series/episode/available", {
          ...
          (response) => {
            if (response.status === 200) {
              for (let i = 0; i < response.data.list.length; i++) {
                this.data.season.data[response.data.list[i].key].show =
