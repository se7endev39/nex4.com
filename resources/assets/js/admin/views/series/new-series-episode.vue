          ...
          <div class="col-12 col-lg-6">
                ...
                <div class="alert alert-info" role="alert">
                  ...
                  <ol>
                    <li>
                      ...
                      upload multiple episode in same time. <br />
                    </li>
                    <li>
            ...
            <div v-if="cloud_type">
              <div class="col-12 col-sm-12">
                <div class="form-group">
                  ...
                  <select class="form-control" v-model="season" id="Session">
                    <option v-for="(list, index) in listSession" :key="index">
                      {{ list }}
                    </option>
                  </select>
                </div>
              ...
              <div class="col-12 col-sm-12">
                <div class="form-group">
                  ...
                  <select
                    ...
                    multiple
                  >
                    <option v-for="(list, index) in listEpiosde" :key="index">
                      {{ list }}
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group">
                <div class="col-12">
                  ...
                  <small class="text-muted"
                    >If you upload External Link, choose 1 episode</small
                  >
                  <select
                    class="form-control"
                    v-validate="'required'"
                    name="upload_type"
                    v-model="upload_type_is"
                    id="upload_type"
                  >
                  ...
                  <span v-show="errors.has('upload_type')" class="is-danger">{{
              ...
              <transition name="menu-popover">
                <div
                  class="transcoding-section"
                  v-show="upload_type_is == 'transcoding'"
                >
                  <div
                    class="form-group"
                    v-if="upload_type_is == 'transcoding'"
                  >
                    ...
                    <div class="col-12">
                      <input
                        type="file"
                        id="video"
                        @change="infoShow('video', 'videoFileDetails')"
                        class="inputfile"
                        multiple
                      />
                  ...
                  >
                    <div class="col-12">
                      ...
                      <span v-show="errors.has('presets')" class="is-danger">{{
                        errors.first("presets")
                      }}</span>
                    </div>
                  </div>
                </div>
              ...
              <transition name="menu-popover">
                <div
                  class="external-link"
                  v-show="upload_type_is == 'externalUrl'"
                >
                  <div
                    class="external-link"
                    v-show="upload_type_is == 'externalUrl'"
                  >
                    <div
                      class="form-group"
                      v-if="upload_type_is == 'externalUrl'"
                    >
                      <div class="col-12">
                        <label
                          >Episode
                          <small class="form-text text-muted"
                            >External Link (360p)</small
                          >
                        </label>
                      </div>
                      <div class="col-12">
              ...
              <transition name="menu-popover">
                <div class="col-12">
                  <div
                    class="embed-code"
                    v-show="upload_type_is === 'embedCode'"
                  >
                    ...
                    <div
                      class="embed-list"
                      v-for="(item, index) in embedCodeList"
                      :key="index"
                    >
                      <hr />
                      <div class="form-group">
                        ...
                        >
                          <option
                            v-for="(item1, index1) in ListProduction"
                            :key="index1"
                            :value="item1.id"
                          >
                            {{ item1.name }}
                        ...
                        <span
                          v-show="errors.has('production')"
                          class="c-danger-text"
                          >{{ errors.first("production") }}</span
                        >
                      </div>
                      <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    MOVIEVIDEO_S3(data) {
      ...
      axios
        .post(
          "/api/admin/new/series/episode/video",
          this.uploadFormData,
          progress
        )
        .then(
