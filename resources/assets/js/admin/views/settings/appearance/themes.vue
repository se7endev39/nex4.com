    ...
    <div class="container theme">
      <div class="col-12 my-3 p-2">
        ...
        <div class="col-12">
          <div class="row">
            <div
              class="col-12 col-sm-4 col-lg-4 theme-box"
            ...
            >
              ...
              <div class="control mt-1">
                <div class="group-btn">
                  <button
                    v-if="!button_loading && item.status === 0"
                    @click="SET(item.id)"
                    class="btn btn-md btn-warning"
                  >
                    Set
                  </button>
                  <button v-else class="btn btn-md btn-success" disabled>
                    Active
                  </button>
                  <button
            ...
            <div class="col-12 col-sm-4 col-lg-4">
              ...
              <span v-show="errors.has('theme-zip')" class="is-danger">{{
                errors.first("theme-zip")
              }}</span>
            </div>
          </div>
        </div>
