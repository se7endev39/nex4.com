            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <select multiple class="form-control" name="genres"
                                    v-model="genres">
                                <option v-for="(item, index) in genre_list" :value="item.name" :key="index">{{item.name}}</option>
                ...
                <div class="col-12 col-md-6 cast">
                    ...
                    <div id="accordion resolution-videos" class="mt-4">
                        <h5 class="title p-2">Videos</h5>
                        <div class="card" v-for="(item, index) in data.videos" :key="index">
                            <div class="card-header" :id="'heading' + index" v-if="item.video_format !== 'embed' ">
                                <h5 class="mb-0">
                            ...
                            <div :id="'collapse'+ index" class="collapse show" :aria-labelledby="'heading' + index"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" v-if="item.video_format !== 'embed'">
                                        <label for="link" class="m-1">Video Link</label>
                                        <input type="text" name="link" class="form-control" id="link"
                                               v-model="item.video_url">
                                    </div>
                                    <div class="form-group" v-if="item.video_format === 'embed'">
                                        <label for="link" class="m-1">Embed Code {{index+1}}</label>
                                        <textarea type="text" name="link" rows="5" class="form-control" id="embed"
                                                  v-model="item.embed_code" placeholder="Put your new code for update"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
