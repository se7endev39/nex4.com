            ...
            <div v-if="cloud_type">
              ...
              <div class="form-group">
                ...
                <div class="col-12">
                  ...
                  >
                    <option
                      v-for="(item, index) in categories_list.categories"
                      :key="index"
                      :value="item.id"
                    >
                      {{ item.name }}
                  ...
                  <span v-show="errors.has('category')" class="is-danger">{{
              ...
              <div class="form-group">
                <div class="col-12">
                  ...
                  <span v-show="errors.has('age')" class="is-danger">{{
                    errors.first("age")
                  }}</span>
                </div>
              </div>
