...
<div class="create-movie-ads">
    ...
    <div class="k1_manage_table" v-if="!spinner_loading">
        ...
        <div class="title p-2">Movie Ads</div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-12 col-md-8">
                            ...
                            <select class="form-control" id="ad-client" name="ad-client" v-validate="'required'" multiple
                                        >
                    ...
                    <div class="form-group">
                        <div class="col-12 col-md-8">
                            ...
                            <div class="col-12 schedule-ads" v-for="(item, index) in ads" :key="index">
...
export default {
    ...
    computed: mapState({
        ...
        movie_data: state => state.movies.data,
    ...
    created() {
        ...
        // schedules ads
        axios
            .get("/api/admin/get/movies/schedules/ads/" + this.$route.params.id)
            .then(resposne => {
