        ...
        >
          <div id="content">
            <ul class="list-unstyled" id="list-menu">
              ...
              <li>
                <div class="c-dropdown">
                  <div class="ref-dropdown" @click="SHOW_DROPDOWN('movies')">
                    ...
                    <span
                      class="c-dropdown-icon-up"
                      v-if="dropdown_movies == 'movies'"
                    ></span>
                    <span
                      class="c-dropdown-icon-down"
                      v-if="dropdown_movies != 'movies'"
                    ></span>
                  </div>
                  ...
                  <div class="c-dropdown-animation">
                    <transition name="menu-popover">
                      <div
                        ...
                        v-show="dropdown_movies == 'movies'"
                      >
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'movies-manage' }"
                            >Movies Manage</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'movie-api' }"
                            >API Upload</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'movie-custom' }"
                            >Custom Upload</router-link
                          >
                        </div>
                      </div>
                    </transition>
                ...
                <div class="c-dropdown">
                  ...
                  <div class="c-dropdown-animation">
                    <transition name="menu-popover">
                      <div
                        class="c-dropdown-content"
                        v-show="dropdown_series == 'series'"
                      >
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'series-manage' }"
                            >Series Manage</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'series-api' }"
                            >Series API Upload</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'series-custom' }"
                            >Series Custom Upload</router-link
                          >
                        </div>
                      </div>
                    </transition>
              ...
              <li>
                <div class="c-dropdown">
                  <div class="ref-dropdown" @click="SHOW_DROPDOWN('manga')">
                    <img
                      src="/themes/default/img/admin/series.svg"
                      alt="series"
                      width="23px"
                  ...
                  <div class="c-dropdown-animation">
                    <transition name="menu-popover">
                      <div
                        class="c-dropdown-content"
                        v-show="dropdown_series == 'manga'"
                      >
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'manga-manage' }"
                            >Manga Manage</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'manga-api' }"
                            >Manga API Upload</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'manga-custom' }"
                            >Manga Custom Upload</router-link
                          >
                        </div>
                      </div>
                    </transition>
              ...
              <li>
                <router-link :to="{ name: 'ads-manage' }">
                  <img
                    src="/themes/default/img/admin/ads.svg"
                    alt="advertisement"
                    width="20px"
                  />
                  <strong>VAST/Google Ads</strong>
                </router-link>
              </li>
              <li>
              ...
              <li>
                <router-link
                  :to="{ name: 'file-manager', params: { link: 'root' } }"
                >
                  <img
              ...
              <li v-if="permission === 1">
                <div class="c-dropdown">
                  <div class="ref-dropdown" @click="SHOW_DROPDOWN('settings')">
                    <img
                      src="/themes/default/img/admin/settings.svg"
                      alt="settings"
                      width="23px"
                    />
                    ...
                    <span
                      class="c-dropdown-icon-up"
                      v-if="dropdown_settings == 'settings'"
                    ></span>
                    <span
                      class="c-dropdown-icon-down"
                      v-if="dropdown_settings != 'settings'"
                  ...
                  <div class="c-dropdown-animation">
                    <transition name="menu-popover">
                      <div
                        class="c-dropdown-content"
                        v-show="dropdown_settings == 'settings'"
                      >
                        <div class="c-dropdown-item">
                        ...
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'admins-users-manage' }"
                            >Administrator Users</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'tmdb-manage' }"
                            >TMDB API</router-link
                          >
                        </div>
                        <div class="c-dropdown-item">
                          <router-link :to="{ name: 'braintree-subscribe' }"
                            >Braintree Settings</router-link
                          >
                        </div>
                      </div>
                    </transition>
        ...
        <div class="col-md-3 col-xl-2 hidden-sm-down" id="side-navbar">
          <div id="content">
            <ul class="list-unstyled" id="list-menu">
              ...
              <li>
                <router-link :to="{ name: 'embed-management' }">
                  <img
                  ...
                  <strong>Embed Sites</strong>
                </router-link>
              </li>

              <li>
                <router-link :to="{ name: 'genre-management' }">
                  <img
                    src="/themes/default/img/admin/embed.svg"
                    alt="embed"
                    width="23px"
                  ...
                  <strong>Genre Management</strong>
                </router-link>
              </li>
              <li>
                <router-link :to="{ name: 'actors-manage' }">
  ...
  methods: {
    SHOW_DROPDOWN(x, t) {
      if (x == "movies") {
        ...
        if (this.dropdown_manga == x) {
          this.dropdown_manga = false;
        } else {
          this.dropdown_manga = x;
        }
      } else {
