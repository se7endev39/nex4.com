...
let routes = [
...

    {
        ...
        component: require('./views/series/episode-ads.vue')
    },
    {
        name: 'movie-ads',
        path: '/movie/movies-manage/:id/update-ads',
        component: require('./views/movies/movie-ads.vue')
    },
...

    {
        path: '/ad/create',
        name: 'create-ad',
        component: require('./views/ads/create.vue')
    },
    {
        path: '/ad/edit/:id',
        name: 'edit-ad',
        component: require('./views/ads/edit.vue')
    },

    {
        path: '/embed/manage',
        name: 'embed-management',
        component: require('./views/embed-management/manage.vue')
    },

    {
        path: '/embed/create',
        name: 'create-embed',
        component: require('./views/embed-management/create.vue')
    },
    {
        path: '/embed/edit/:id',
        name: 'edit-embed',
        component: require('./views/embed-management/edit.vue')
    },

    {
        path: '/manage/genre-list',
        name: 'genre-management',
        component: require('./views/genre-management/manage')
    },
    {
        path: '/help',
        name: 'help',
