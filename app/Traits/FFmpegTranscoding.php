...
trait FFmpegTranscoding
{
    ...
    public function transcodingToHLS($tempPathVideo, $resolution, $path_upload, $name, $message, $tmdb_id)
    {
        ...
        $convert = FFMpeg::fromDisk('public')
            ->open($tempPathVideo)
            ->exportForHLS()
            ->withRotatingEncryptionKey(function ($name, $contents) {
                Storage::disk('public')->put( $this->path_upload . '/' . $name, $contents);
            })
            ->setSegmentLength(6)
            ->toDisk('public');
        ...
        $convert->save($path_upload . '/' . $name . '.m3u8');
    ...
    public function transcodeVideoToMp4($resolution, $id, $path, $tmdb_id, $cloud, $item_name)
    {
        ...
        foreach ($resolution as $key => $value) {
            if ($value['Resolution'] === '4k') {
                ...
                $newNameMP4 = Str::random(20) . '-2160.mp4';
            ...
            if ($value['Resolution'] === '1080') {
                ...
                $newNameMP4 = Str::random(20) . '-1080.mp4';
            ...
            if ($value['Resolution'] === '720') {
                ...
                $newNameMP4 = Str::random(20) . '-720.mp4';
            ...
            if ($value['Resolution'] === '480') {
                ...
                $newNameMP4 = Str::random(20) . '-480.mp4';
            ...
            if ($value['Resolution'] === '320') {
                ...
                $newNameMP4 = Str::random(20) . '-320.mp4';
