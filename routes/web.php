...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    /// Genres
    Route::get('/api/admin/get/genres', 'Admin\GenresController@getAllGenres');
    Route::post('/api/admin/create/genres', 'Admin\GenresController@createGenre');
    Route::delete('/api/admin/delete/genres/{id}', 'Admin\GenresController@deleteGenre');

    // ADS
    Route::get('/api/admin/get/ads', 'Admin\AdsVastController@getAllAds');
    Route::get('/api/admin/get/ads/{id}', 'Admin\AdsVastController@getAd');
    Route::post('/api/admin/create/ads', 'Admin\AdsVastController@createAd');
    Route::post('/api/admin/update/ads', 'Admin\AdsVastController@updateAd');
    Route::delete('/api/admin/delete/ads/{id}', 'Admin\AdsVastController@deleteAd');

    // Movie VAST ADS
    Route::get('/api/admin/get/movies/schedules/ads/{id}', 'Admin\MovieController@getSchedulesAds');
    Route::post('/api/admin/create/movies/schedules/ads/{id}', 'Admin\MovieController@createSchedulesAds');

    // Episode VAST ADS
    Route::get('/api/admin/get/series/episode/schedules/ads/{id}', 'Admin\SeriesController@getSchedulesAds');
    Route::post('/api/admin/create/series/episode/schedules/ads/{id}', 'Admin\SeriesController@createSchedulesAds');


    /// Live Tv VAST ADS
    Route::get('/api/admin/get/tv/schedules/ads/{id}', 'Admin\TvController@getSchedulesAds');
    Route::post('/api/admin/create/tv/schedules/ads/{id}', 'Admin\TvController@createSchedulesAds');
    Route::delete('/api/admin/delete/tv/schedules/ads/{id}', 'Admin\TvController@deleteSchedulesAds');

    //Embed Production
    Route::get('/api/admin/get/production', 'Admin\EmbedSiteController@ListProduction');
    Route::get('/api/admin/get/production/{id}', 'Admin\EmbedSiteController@ProductionInfo');
    Route::post('/api/admin/create/production', 'Admin\EmbedSiteController@CreateProduction');
    Route::post('/api/admin/update/production/{id}', 'Admin\EmbedSiteController@UpdateProduction');
