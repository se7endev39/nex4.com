"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_admin_views_manga_manage_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/admin/views/manga/manage.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/admin/views/manga/manage.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)({
    ...
    data_search: function data_search(state) {
      return state.manga.data_search;
    },
  ...
  methods: {
    DELETE: function DELETE(id, key) {
      ...
      swal({
        ...
        if (willDelete) {
          _this.$store.dispatch("DELETE_MANGA", {
            id: id,
            key: key
          });
        }
    ...
    USERS_ONLY: function USERS_ONLY(vai) {
      ...
      axios.post("/api/admin/update/manga/users-only", {
        list: this.multi_select,
        users_only: vai
      }).then(function (response) {
        if (response.status === 200) {
          for (var _i = 0; _i < response.data.list.length; _i++) {
            _this2.data.manga.data[response.data.list[_i].key].mangas_users_only = vai;
          }
    ...
    ADD_ALL_TO_MULITSELECT: function ADD_ALL_TO_MULITSELECT() {
      if (this.multi_select.length > 0) {
        ...
        for (var _i2 = 0; _i2 < this.data.manga.data.length; _i2++) {
          this.multi_select.push({
            id: this.data.manga.data[_i2].mangas_id,
            key: _i2
          });
          document.getElementById(this.data.manga.data[_i2].mangas_id).checked = true;
        }
      }
    }
  }
...
/***/ "./resources/assets/js/admin/views/manga/manage.vue":
/*!**********************************************************!*\
  !*** ./resources/assets/js/admin/views/manga/manage.vue ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manage.vue?vue&type=template&id=33abeada& */ "./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada&");
/* harmony import */ var _manage_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./manage.vue?vue&type=script&lang=js& */ "./resources/assets/js/admin/views/manga/manage.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__.render,
  _manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/admin/views/manga/manage.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/assets/js/admin/views/manga/manage.vue?vue&type=script&lang=js&":
/*!***********************************************************************************!*\
  !*** ./resources/assets/js/admin/views/manga/manage.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada&":
/*!*****************************************************************************************!*\
  !*** ./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada& ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_manage_vue_vue_type_template_id_33abeada___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./manage.vue?vue&type=template&id=33abeada& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/assets/js/admin/views/manga/manage.vue?vue&type=template&id=33abeada& ***!
  \********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                  ...
                  _vm.data_search.manga !== null
                    ? _c("div", { staticClass: "table-responsive mt-2" }, [
                        _c("div", { staticClass: "table table-hover" }, [
                          ...
                          _c(
                            "tbody",
                            _vm._l(_vm.data_search.manga, function(
                              item,
                              index
                            ) {
                              return _c("tr", { key: index }, [
                                item.mangas_cloud == "local"
                                  ? _c("td", [
                                      _c("img", {
                                        attrs: {
                                          src:
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                item.mangas_cloud == "aws"
                                  ? _c("td", [
                                      _c("img", {
                                        attrs: {
                                          src:
                                            _vm.sm_poster + item.mangas_poster,
                                          alt: item.mangas_name,
                                          width: "40"
                                        }
                                      })
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(item.mangas_name))]),
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(item.mangas_year))]),
                                _vm._v(" "),
                                item.mangas_cloud == "local"
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      !_vm.button_loading
                                        ...
                                        : _vm._e(),
                                      _vm._v(" "),
                                      _vm.button_loading === item.mangas_id
                                        ? _c(
                                            "button",
                                            {
                                              staticClass:
                  ...
                  Object.keys(_vm.data_search).length === 0
                    ? _c("div", { staticClass: "table-responsive mt-2" }, [
                        _c("div", { staticClass: "table table-hover" }, [
                          ...
                          _c(
                            "tbody",
                            _vm._l(_vm.data.manga.data, function(item, index) {
                              return _c("tr", { key: index }, [
                                _c(
                                  "td",
                                  { staticStyle: { "text-align": "center" } },
                          ...
                          _c("ul", { staticClass: "pagination" }, [
                            ...
                            _c(
                              "li",
                              {
                                ...
                                class: {
                                  disabled:
                                    _vm.data.manga.prev_page_url === null
                                },
                                attrs: { id: "prev" }
                              },
                              [
                            ...
                            _c("li", { staticClass: "page-item" }, [
                              _c("a", { staticClass: "page-link" }, [
                                _vm._v(
                                  _vm._s(_vm.data.manga.current_page) +
                                    "/" +
                                    _vm._s(_vm.data.manga.last_page)
                                )
                              ])
                            ]),
                            _vm._v(" "),
                            _c(
                              "li",
                              {
                                ...
                                class: {
                                  disabled:
                                    _vm.data.manga.next_page_url === null
                                },
                                attrs: { id: "next" }
                              },
                              [
                                ...
                                _c(
                                  "a",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.PAGINATION(
                                          "/api/admin/get/manga?page=" +
                                            _vm.data.manga.last_page
                                        )
                                      }
                                    }
                                  },
